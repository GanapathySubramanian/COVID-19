...
<?php
    if(isset($_POST['search']))
    {
        ...
        $query = "SELECT * FROM `district_cases` WHERE  CONCAT(`districts`,`state_code`) LIKE '%".$valueToSearch."%' order by state_code";
        $search_result = filterTable($query);
    }
    else {
        $query = "SELECT * FROM `district_cases` order by state_code";
        $search_result = filterTable($query);
    }
